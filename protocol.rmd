...
If you downloaded the preprocessed data you can skip the previous steps and
...
shows good good performance with an error of about 3.5% in predicting proliferation
rates.
